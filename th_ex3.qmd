...
::: callout-note
The reference is taken from another course and is not a model template to copy.  It aims to provide students the idea of prototyping and how to modularise the proposed geospatial analytics application so that each member of the project team will responsible on at least one major geospatial analytics module of the complete application.
:::
...
Your completed take-home exercise is due on **17th March 2024, by 11:59pm evening**.
